    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-foreground relative overflow-hidden">
      ...
      <div className="glass-card p-6 space-y-6 hover:scale-[1.02] transition-all duration-300">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-semibold text-white">Bộ lọc & Tìm kiếm</h3>
        </div>
        ...
        <Table className="min-w-[600px] hidden sm:table">
          <TableHeader>
            <TableRow className="border-gray-700">
              ...
              <TableHead className="hidden lg:table-cell text-white font-semibold">Địa chỉ</TableHead>
              <TableHead className="hidden md:table-cell text-white font-semibold">Số lượng</TableHead>
              <TableHead className="hidden md:table-cell text-white font-semibold">Giá trị</TableHead>
              <TableHead className="hidden md:table-cell text-white font-semibold">Trạng thái</TableHead>
              <TableHead className="text-right text-white font-semibold">Ngày</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {staticTransactions.map((tx, index) => (
              <TableRow key={index} className="border-gray-700 hover:bg-white/5 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="space-x-2">
            <Button size="sm" className="bg-purple-500/20 border-purple-400/50 text-purple-100 hover:bg-purple-500/30 hover:border-purple-400 hover:text-purple-50 hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              Trước
            </Button>
            <Button size="sm" className="bg-purple-500/20 border-purple-400/50 text-purple-100 hover:bg-purple-500/30 hover:border-purple-400 hover:text-purple-50 hover:scale-105 transition-all duration-300 backdrop-blur-sm">
              Sau
