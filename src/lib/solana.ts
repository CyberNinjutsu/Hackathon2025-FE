...
class SolanaService {
  ...
  async getRecentTransactions(limit: number = 100): Promise<SolanaTransaction[]> {
    try {
  ...
  private parseTransaction(tx: ParsedTransactionWithMeta, signature: string): SolanaTransaction {
    const meta = tx.meta;
  ...
  private getTransactionType(message: { instructions: Array<{ programId: { toString(): string } }> }): string {
    const programIds = message.instructions.map((ix) => ix.programId.toString());
  ...
  private getTransactionAmount(meta: { preBalances?: number[]; postBalances?: number[] } | null): number {
  ...
  private getMockTransactions(): SolanaTransaction[] {
    ...
    return [
      {
        signature: '5VfYmGBjvxKjKvGdNMVHyd2pHkp2BjBNsU4hkaNNyQuDqbwsuUsb2gkSE2qiQQ6FEjNb7Ex3BvpJbvJ8wVjHEqLs',
        slot: 234567890,
        blockTime: now - 300,
        fee: 5000,
      ...
      {
        signature: '3NZ9JMVBmhWPyqXw8AiUh3JvGpMj1eiWN9C4KQpJ1VGhVb2rJhKGF4Np8Xw2Yv5Z1Qm7Rt6Sw9Uv3Xz8Cb1Df2',
        slot: 234567889,
        blockTime: now - 600,
        fee: 5000,
        status: 'success' as const,
      ...
      {
        signature: '2Kx8JMVBmhWPyqXw8AiUh3JvGpMj1eiWN9C4KQpJ1VGhVb2rJhKGF4Np8Xw2Yv5Z1Qm7Rt6Sw9Uv3Xz8Cb1Df3',
        slot: 234567888,
        blockTime: now - 900,
        fee: 5000,
      ...
      {
        signature: '4Lx9KNVCniXQzrYx9BiVi4KwHqNk2fjXO8D5LrK2WIiWc3sKiLHG5Op9Yx3Zw6A2Rn8Su7Tx0Vw4Yz9Dc2Eg4',
        slot: 234567887,
        blockTime: now - 1200,
        fee: 5000,
        status: 'success' as const,
      ...
      {
        signature: '6Mx0LPWDojYRzsZy0CjWj5LxIrOl3gkYP9E6MsL3XJjXd4tLjMIH6Pq0Zy4Ax7B3So9Tv8Uy1Wx5Za0Ed3Fh5',
        slot: 234567886,
        blockTime: now - 1500,
        fee: 5000,
        status: 'success' as const,
